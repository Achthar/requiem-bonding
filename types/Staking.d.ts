...
interface StakingInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: "gREQ", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "gREQ", data: BytesLike): Result;
...
export class Staking extends BaseContract {
  ...
  functions: {
    ...
    gREQ(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    gREQ(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    gREQ(overrides?: CallOverrides): Promise<PopulatedTransaction>;
