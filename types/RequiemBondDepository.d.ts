...
interface RequiemBondDepositoryInterface extends ethers.utils.Interface {
  functions: {
...
export class RequiemBondDepository extends BaseContract {
  ...
  interface: RequiemBondDepositoryInterface;
