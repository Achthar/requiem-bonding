...
interface MockOlympusTreasuryInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: "sREQQueue", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "sREQQueue", data: BytesLike): Result;
...
export class MockOlympusTreasury extends BaseContract {
  ...
  functions: {
    ...
    sREQQueue(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    sREQQueue(overrides?: CallOverrides): Promise<PopulatedTransaction>;
