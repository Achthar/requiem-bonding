...
interface RequiemQBondingCalculatorInterface extends ethers.utils.Interface {
  functions: {
...
export class RequiemQBondingCalculator extends BaseContract {
  ...
  interface: RequiemQBondingCalculatorInterface;
