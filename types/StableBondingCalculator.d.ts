...
interface StableBondingCalculatorInterface extends ethers.utils.Interface {
  functions: {
...
export class StableBondingCalculator extends BaseContract {
  ...
  interface: StableBondingCalculatorInterface;
